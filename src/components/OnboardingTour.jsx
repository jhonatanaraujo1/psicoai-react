...
const STEPS = [
  {
    ...
    icon: '📅',
    title: 'Agenda',
    desc: 'Sessões do dia com lembretes automáticos. Nunca mais um paciente sem confirmação.',
  },
  {
    id: 'pacientes',
    ...
    icon: '👤',
    title: 'Pacientes',
    desc: 'Prontuário completo, linha do tempo clínica e alertas de padrão por paciente.',
  },
  {
    id: 'cadernos',
    ...
    icon: '✏️',
    title: 'Anotações',
    desc: 'Escreva ou desenhe durante a sessão — depois, um clique aciona a análise IA.',
  },
  {
    id: 'insights',
    ...
    icon: '🧠',
    title: 'Análises IA',
    desc: 'Hipóteses DSM-5/CID-11 com probabilidade. O que você sentia, agora você nomeia.',
  },
  {
    id: 'financeiro',
    ...
    icon: '💰',
    title: 'Financeiro',
    desc: 'Cobranças, recibos e alertas de inadimplência — sem planilha, sem esforço.',
  },
  {
    id: 'formularios',
    ...
    icon: '📋',
    title: 'Formulários',
    desc: 'PHQ-9, Beck, TCLE e SRS prontos. Envie ao paciente com um link, receba preenchido.',
  },
  {
    id: 'config',
    ...
    icon: '⚙️',
    title: 'Configurações',
    desc: 'Ajuste seu perfil, abordagem e plano. O assistente usa isso para personalizar as análises.',
    isLast: true,
  },
]
